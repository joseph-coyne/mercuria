<template>
  <div class="sheet-wrap overflow-hidden">
    ...
    <div
      ref="sheet"
      class="z-40 absolute inset-x-0 bottom-0 flex flex-col content-center items-center bg-white border-t rounded-t-xl shadow-lg h-screen transition-all duration-200 ease"
    >
      <header
        ref="handle"
